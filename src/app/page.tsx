    ...
    <>
      <header className="flex flex-col sm:flex-row items-center gap-3 sm:gap-0 px-5 sm:px-10 lg:px-20 py-3 border-b-2">
        ...
        <div className="flex justify-center sm:justify-end w-full sm:w-1/2">
          <Link href="/login">
            <button className="flex p-3 rounded-md px-8 bg-customBlue text-customLight w-full sm:w-auto justify-center">
              Acessar Plataforma
            </button>
          </Link>
        </div>
      ...
      <div className="flex flex-col justify-center px-5 sm:px-10 lg:px-20 py-10">
        <h2 className="text-3xl sm:text-5xl lg:text-6xl leading-tight font-bold text-center">
          Revolucione a correção <br />
          de redações com <br />
          <span className="text-customBlue">Inteligência Artificial</span>
        </h2>
        <p className="text-center text-base sm:text-lg lg:text-xl mt-6 sm:mt-8">
          Uma plataforma completa que oferece feedback instantâneo e preciso para alunos, e <br />
          ferramentas avançadas de acompanhamento para professores.
        </p>
      ...
      <div className="flex flex-col items-center bg-customBackground py-14 sm:py-20 px-5 sm:px-10 lg:px-20">
        <h2 className="text-2xl sm:text-3xl font-semibold text-center">Por que escolher o EstudAI?</h2>
        <div className="mt-8 sm:mt-10 grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
          <div className="flex flex-col bg-white border rounded-xl p-6 w-full md:w-96">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              className="lucide lucide-zap h-10 w-10 text-primary mb-2"
            >
          ...
          <div className="flex flex-col bg-white border rounded-xl p-6 w-full md:w-96">
            <svg
              ...
              width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              className="lucide lucide-trending-up h-10 w-10 text-accent mb-2"
            >
          ...
          <div className="flex flex-col bg-white border rounded-xl p-6 w-full md:w-96">
            <svg
              ...
              width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              className="lucide lucide-users h-10 w-10 text-primary mb-2"
            >
      ...
      <footer className="flex flex-col items-center px-5 sm:px-10 lg:px-20 py-10 border-t-2">
        ...
        />
        <p className="text-[10px] sm:text-xs mt-6 sm:mt-10 text-center">
          © 2025 EstudAI. Transformando a educação através da tecnologia.
        </p>
      </footer>
    </>
  )
